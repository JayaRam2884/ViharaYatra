...
var accountsinfo=[
    ...
    function fun(){
        window.location.href="../pages/india.html";
    }
    function fun1(){
        window.location.href="../pages/america.html";
    }
    function fun2(){
        window.location.href="../pages/brazil.html";
    }
    function fun3(){
        window.location.href="../pages/italy.html";
    }
    function fun4(){
        window.location.href="../pages/nepal.html";
    }
    function fun5(){
...
function changeintousername(){
    let userchangeid = document.getElementsByClassName("loginanchor")[0];
    userchangeid.innerHTML="User";
}
